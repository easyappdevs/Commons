...
import com.eadevs.commons.databinding.ActivityCustomizationBinding
import com.eadevs.commons.dialogs.*
import com.eadevs.commons.extensions.*
import com.eadevs.commons.helpers.*
import com.eadevs.commons.models.MyTheme
import com.eadevs.commons.models.RadioItem
import com.eadevs.commons.models.SharedTheme
...
class CustomizationActivity : BaseSimpleActivity() {
    ...
    private var isThankYou = false      // show "Apply colors to all Easy apps" in Easy Thank You itself even with "Hide Google relations" enabled
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        isThankYou = packageName.removeSuffix(".debug") == "com.eadevs.thankyou"
        initColorVariables()
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("com.eadevs.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }
