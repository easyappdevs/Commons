...
import com.eadevs.commons.compose.extensions.onEventValue
import com.eadevs.commons.compose.screens.ManageBlockedNumbersScreen
import com.eadevs.commons.compose.theme.AppThemeSurface
import com.eadevs.commons.dialogs.AddOrEditBlockedNumberAlertDialog
import com.eadevs.commons.dialogs.ExportBlockedNumbersDialog
import com.eadevs.commons.dialogs.FilePickerDialog
...
class ManageBlockedNumbersActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val isDialer = remember {
                config.appId.startsWith("com.eadevs.phone")
            }
    ...
    private fun maybeSetDefaultCallerIdApp() {
        if (isQPlus() && baseConfig.appId.startsWith("com.eadevs.phone")) {
