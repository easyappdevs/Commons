...
import com.eadevs.commons.extensions.getIntValue
import com.eadevs.commons.extensions.getStringValue
import com.eadevs.commons.models.PhoneNumber
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.eadevs.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.eadevs.phone" && packageName != "com.eadevs.messages" && packageName != "com.eadevs.calendar") {
                return contacts
            }
