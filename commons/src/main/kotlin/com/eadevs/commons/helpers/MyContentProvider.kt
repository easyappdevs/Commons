...
class MyContentProvider {
    companion object {
        private const val AUTHORITY = "com.eadevs.commons.provider"
        const val SHARED_THEME_ACTIVATED = "com.eadevs.commons.SHARED_THEME_ACTIVATED"
        const val SHARED_THEME_UPDATED = "com.eadevs.commons.SHARED_THEME_UPDATED"
        val MY_CONTENT_URI = Uri.parse("content://$AUTHORITY/themes")

        const val COL_ID = "_id"    // used in Easy Thank You
