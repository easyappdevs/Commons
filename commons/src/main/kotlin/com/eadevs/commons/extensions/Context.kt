...
import com.eadevs.commons.models.AlarmSound
import com.eadevs.commons.models.BlockedNumber
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.eadevs.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("com.eadevs.thankyou")
...
fun Context.isAProApp() = packageName.startsWith("com.eadevs.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.eadevs."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.eadevs.contacts") && !packageName.startsWith("com.eadevs.phone")) {
        true
    } else if ((packageName.startsWith("com.eadevs.contacts") || packageName.startsWith("com.eadevs.phone")) && isQPlus()) {
