...
import com.eadevs.commons.databinding.DialogTitleBinding
...
import com.eadevs.commons.models.*
import com.eadevs.commons.views.MyTextView
...
fun Activity.appLaunched(appId: String) {
    ...
    if (baseConfig.appRunCount == 0) {
        ...
        if (baseConfig.appIconColor != primaryColor) {
            ...
            val blueClassName = "${baseConfig.appId.removeSuffix(".debug")}.activities.SplashActivity.Blue"
            packageManager.setComponentEnabledSetting(
...
fun Activity.launchPurchaseThankYouIntent() {
    hideKeyboard()
    try {
        launchViewIntent("market://details?id=com.eadevs.thankyou")
...
fun Activity.openPathIntent(
    ...
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "com.eadevs.gallery" || applicationId == "com.eadevs.gallery.debug") {
...
fun BaseSimpleActivity.launchCallIntent(recipient: String, handle: PhoneAccountHandle? = null) {
    handlePermission(PERMISSION_CALL_PHONE) {
        ...
        Intent(action).apply {
            ...
            if (isDefaultDialer()) {
                val packageName = if (baseConfig.appId.contains(".debug", true)) "com.eadevs.phone.debug" else "com.eadevs.phone"
                val className = "com.eadevs.phone.activities.DialerActivity"
